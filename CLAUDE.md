...
The index/search fingerprint was advanced to `semantic-fts-v4-exact-phrases`, so
cached results generated by the old ranker are not reused. Integration coverage
